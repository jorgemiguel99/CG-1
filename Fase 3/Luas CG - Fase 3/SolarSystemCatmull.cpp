...
float MoonsRadiusOrbits[9] = {0,20,25,10,15,25,10,25,20};
int planet=0;
...
void renderScene(void) {
	...
	float planetsRadiusOrbits[9] = {0,30,50,90,110,120,140,160,180};
	float MoonsRadiusOrbits[9] = {0,30,50,20,40,35,25,45,30};

for(position=0;position<numberCurves;position++){
	if(position<2) glTranslatef(-5, 0, 0);
	switch (position) {
		case 2:
					glTranslatef(15, 0, 0);
					break;
	...
	p[0][0] = (4.0/2)*MoonsRadiusOrbits[position];
	p[0][1] = 0;
	p[0][2] = 0;

	p[1][0] = (3.8/2)*MoonsRadiusOrbits[position];
	p[1][1] = 0;
	p[1][2] = (-1.5/2)*MoonsRadiusOrbits[position];

	p[2][0] = (3.0/2)*MoonsRadiusOrbits[position];
	p[2][1] = 0;
	p[2][2] = (-2.0/2)*MoonsRadiusOrbits[position];

	p[3][0] = (2.2/2)*MoonsRadiusOrbits[position];
	p[3][1] = 0;
	p[3][2] = (-1.5/2)*MoonsRadiusOrbits[position];

	p[4][0] = (2.0/2)*MoonsRadiusOrbits[position];
	p[4][1] = 0;
	p[4][2] = 0;

	p[5][0] = (2.2/2)*MoonsRadiusOrbits[position];
	p[5][1] = 0;
	p[5][2] = (1.5/2)*MoonsRadiusOrbits[position];

	p[6][0] = (3.0/2)*MoonsRadiusOrbits[position];
	p[6][1] = 0;
	p[6][2] = (2.0/2)*MoonsRadiusOrbits[position];

	p[7][0] = (3.8/2)*MoonsRadiusOrbits[position];
	p[7][1] = 0;
	p[7][2] = (1.5/2)*MoonsRadiusOrbits[position];
