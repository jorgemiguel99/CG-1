...
void prepareBox(float length, float width, float height) {
  ...
  // Vertices -------------------------------------------------------------
  // Front face
  v[vertexV++] = 0.0f;v[vertexV++] = 0.0f; v[vertexV++] = 0.0f;
  n[vertexN++] = 0.0f; n[vertexN++] = 0.0f; n[vertexN++] = 1.0f;
  t[vertexT++] = 0.0f; t[vertexT++] = 0.0f;

  box << "0.0 " << "0.0 " << "0.0" << endl; // Vertex
  box << "0.0 " << "0.0 " << "1.0" << endl; // Normals
  box << "0.0 " << "0.0" << endl; // Texture

  v[vertexV++] = width; v[vertexV++] = 0.0f; v[vertexV++] = 0.0f;
  n[vertexN++] = 0.0f; n[vertexN++] = 0.0f; n[vertexN++] = 1.0f;
  t[vertexT++] = 1.0f; t[vertexT++] = 0.0f;

  box << width << " 0.0 " << "0.0" << endl; // Vertex
  box << "0.0 " << "0.0 " << "1.0" << endl; // Normals
  box << "1.0 " << "0.0" << endl; // Texture

  v[vertexV++] = 0.0f; v[vertexV++] = height; v[vertexV++] = 0.0f;
  n[vertexN++] = 0.0f; n[vertexN++] = 0.0f; n[vertexN++] = 1.0f;
  t[vertexT++] = 0.0f; t[vertexT++] = 1.0f;

  box << "0.0 " << height << " 0.0" << endl; // Vertex
  box << "0.0 " << "0.0 " << "1.0" << endl; // Normals
  box << "0.0 " << "1.0" << endl; // Texture
  ...
  v[vertexV++] = width; v[vertexV++] = height; v[vertexV++] = 0.0f;
  n[vertexN++] = 0.0f; n[vertexN++] = 0.0f; n[vertexN++] = 1.0f;
  t[vertexT++] = 1.0f; t[vertexT++] = 1.0f;

  box << width << " " << height << " 0.0" << endl; // Vertex
  box << "0.0 " << "0.0 " << "1.0" << endl; // Normals
  box << "1.0 " << "1.0" << endl; // Texture
  ...
  // Back face
  v[vertexV++] = width; v[vertexV++] = 0.0f; v[vertexV++] = -length;
  n[vertexN++] = 0.0f; n[vertexN++] = 0.0f; n[vertexN++] = -1.0f;
  t[vertexT++] = 0.0f; t[vertexT++] = 0.0f;

  box << width << " 0.0 " << -length << endl; // Vertex
  box << "0.0 " << "0.0 " << "-1.0" << endl; // Normals
  box << "0.0 " << "0.0" << endl; // Texture

  v[vertexV++] = 0.0f; v[vertexV++] = 0.0f; v[vertexV++] = -length;
  n[vertexN++] = 0.0f; n[vertexN++] = 0.0f; n[vertexN++] = -1.0f;
  t[vertexT++] = 1.0f; t[vertexT++] = 0.0f;

  box << "0.0 " << "0.0 " << -length << endl; // Vertex
  box << "0.0 " << "0.0 " << "-1.0" << endl; // Normals
  box << "1.0 " << "0.0" << endl; // Texture

  v[vertexV++] = 0.0f; v[vertexV++] = height; v[vertexV++] = -length;
  n[vertexN++] = 0.0f; n[vertexN++] = 0.0f; n[vertexN++] = -1.0f;
  t[vertexT++] = 1.0f; t[vertexT++] = 1.0f;

  box << "0.0 " << height << " " << -length << endl; // Vertex
  box << "0.0 " << "0.0 " << "-1.0" << endl; // Normals
  box << "1.0 " << "1.0" << endl; // Texture
  ...
  v[vertexV++] = width; v[vertexV++] = height; v[vertexV++] = -length;
  n[vertexN++] = 0.0f; n[vertexN++] = 0.0f; n[vertexN++] = -1.0f;
  t[vertexT++] = 0.0f; t[vertexT++] = 1.0f;

  box << width << " " << height << " " << -length << endl; // Vertex
  box << "0.0 " << "0.0 " << "-1.0" << endl; // Normals
  box << "0.0 " << "1.0" << endl; // Texture
  ...
  // Right face
  v[vertexV++] = width; v[vertexV++] = 0.0f; v[vertexV++] = 0.0f;
  n[vertexN++] = 1.0f; n[vertexN++] = 0.0f; n[vertexN++] = 0.0f;
  t[vertexT++] = 0.0f; t[vertexT++] = 0.0f;

  box << width << "0.0 " << "0.0" << endl; // Vertex
  box << "1.0 " << "0.0 " << "0.0" << endl; // Normals
  box << "0.0 " << "0.0" << endl; // Texture
  ...
  // Upper face
  v[vertexV++] = 0.0f; v[vertexV++] = height; v[vertexV++] = 0.0f;
  n[vertexN++] = 0.0f; n[vertexN++] = 1.0f; n[vertexN++] = 0.0f;
  t[vertexT++] = 0.0f; t[vertexT++] = 0.0f;

  box << "0.0 " << height << " 0.0" << endl; // Vertex
  box << "0.0 " << "1.0 " << "0.0" << endl; // Normals
  box << "0.0 " << "0.0" << endl; // Texture
